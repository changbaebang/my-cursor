...
| 항목 | 내용 |
|------|------|
| **로그인** | `gh auth login` (keyring, 계정 `your-github-user` 등) |
...
# 또는
~/.cursor/scripts/cb/gh-with-keyring.sh pr view 6966 --repo your-org/frontend-monorepo
```
...
```bash
export GH_TOKEN="$(env -u GH_TOKEN -u GITHUB_AUTH_TOKEN gh auth token)"
gh api repos/<owner>/<repo>/pulls/<N>/requested_reviewers -f 'reviewers[]=your-github-user'
